...
<cftry>
	...
	<cfscript>
		...
		// 検索クエリを発行するコンポーネント
		dataGateway = CreateObject("component", "#SERVICE_ADDRESS#.manager.StudentsGateway").init(DSN = DSN, SERVICE_ADDRESS = SERVICE_ADDRESS, COMMON_SERVICE_ADDRESS = COMMON_SERVICE_ADDRESS);
		// 検索クエリを発行するコンポーネント
