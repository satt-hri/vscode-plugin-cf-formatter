<cfcomponent>
    ...
    <cfswitch expression="#sponsorshipDisplayID#">
        <cfcase value="1">
            <cfset result = "su" />
        </cfcase>
    <cfdefaultcase>
    ...
    <cffunction name="xmlEscapeString" access="private" returntype="string" output="false" hint="エスケープ文字変換">
        ...
        <cfquery datasource="#Application.DSN#">
            UPDATE sco_progress
            SET
                <cfif coreLog_array[1] neq "null">
                    completion_status = <cfqueryparam cfsqltype="cf_sql_varchar" value="#coreLog_array[1]#" />,
                </cfif>
                <cfif coreLog_array[4] neq "null">
                    session_time = <cfqueryparam cfsqltype="cf_sql_varchar" value="#coreLog_array[4]#" />,
